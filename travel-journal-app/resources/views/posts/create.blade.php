        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">Nuova Avventura</h5>
                </div>
                <div class="card-body">
                    <form action="{{route('posts.store')}}" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="positive" name="positive" rows="2" placeholder=""></textarea>
                        </div>

                        {{-- CONTRO --}}
                        <div class="mb-3">
                            <label for="negative" class="form-label">Contro: </label>
                            <textarea class="form-control" id="negative" name="negative" rows="2" placeholder=""></textarea>
                        </div>
                       ...
                       {{-- IMPEGNO FISICO --}}
                        <div class="mb-3">
                            ...
                            <option value="" disabled selected>Seleziona un numero</option>
                                @for ($i = 1; $i <= 5; $i++)
